...
class ApproximateQAgent(PacmanQAgent):
    ...
    def __init__(self, extractor='IdentityExtractor', **args):
        ...
        # self.weights = {'eats-food': 203.16169330764052, 'closest-food': 4.9076532949304985, 'bias': -137.70460679974684, '#-of-ghosts-1-step-away': -2665.582801648681}
    ...
    def getQValue(self, state, action):
        ...
        return features.__mul__(self.weights)
